...
router.get('/recibir_pago',isAuth, can_RealizarPago, pagosController.get_recibir_pago);
router.post('/recibir_pago',isAuth, can_RealizarPago, pagosController.post_recibir_pago);

router.post('/respuesta_pago',isAuth, can_RealizarPago, pagosController.post_respuesta_pago);
