...
router.get('/editar_diplomado',can_ModificarDiplomado,diplomadoController.get_modificar_diplomado);
router.get('/check_diplomado',can_ModificarDiplomado,diplomadoController.get_check_diplomado);
router.get('/autocomplete',can_ModificarDiplomado,diplomadoController.get_autocomplete);
router.post('/editar_diplomado',can_ModificarDiplomado,diplomadoController.post_fetch_diplomado);
router.post('/resultado_diplomado',can_ModificarDiplomado,diplomadoController.post_modificar_diplomado);
